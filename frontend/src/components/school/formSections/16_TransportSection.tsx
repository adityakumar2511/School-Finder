          ...
          {available && (
            <div className="space-y-4 pt-2">
              ...
              <div className="space-y-1.5">
                <Label className="font-heading text-label text-gray-800">Number of Vehicles</Label>
              ...
              <div className="space-y-1.5">
                <Label className="font-heading text-label text-gray-800">Coverage Areas</Label>
                <Textarea
