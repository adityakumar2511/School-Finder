...
const FIELDS: { key: "clubs" | "culturalActivities" | "annualEvents" | "educationalTours"; label: string; placeholder: string }[] = [
  {
    ...
    placeholder: "e.g. Science Club, Eco Club, Literary Society, Photography Club…",
  },
  {
    key: "culturalActivities",
    label: "Cultural Activities",
    placeholder: "e.g. Annual cultural fest, dance competitions, drama performances…",
  },
  {
    key: "annualEvents",
    label: "Annual Events",
    placeholder: "e.g. Sports Day, Republic Day, Independence Day, Annual Function…",
  },
  {
    key: "educationalTours",
    label: "Educational Tours & Trips",
    placeholder: "e.g. Heritage tours, science museum visits, nature camps…",
  },
];
