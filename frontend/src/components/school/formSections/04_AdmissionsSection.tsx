    ...
    <div className="space-y-6">
      ...
      <Card className="border border-gray-100 shadow-card rounded-2xl bg-white">
        <CardContent className="p-6 space-y-5">
          ...
          <div className="space-y-1.5">
            <Label className="font-heading text-label text-gray-800">Age Criteria</Label>
            <Input
          ...
          <div className="space-y-1.5">
            <Label className="font-heading text-label text-gray-800">Required Documents</Label>
            <textarea
