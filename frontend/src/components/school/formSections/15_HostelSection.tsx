    ...
    <div className="space-y-6">
      ...
      <Card className="border border-gray-100 shadow-card rounded-2xl bg-white">
        <CardContent className="p-6 space-y-4">
          ...
          {/* Conditional fields — show only if hostel is available */}
          {available && (
            <div className="space-y-4 pt-2">
              <ToggleRow
                label="Boys Hostel"
                checked={boys}
                onChange={(val) => setValue("hostel.boys", val)}
              />
              <ToggleRow
                label="Girls Hostel"
                checked={girls}
                onChange={(val) => setValue("hostel.girls", val)}
              />
              <ToggleRow
              ...
              <div className="space-y-1.5 pt-1">
                <Label className="font-heading text-label text-gray-800">Total Hostel Capacity</Label>
