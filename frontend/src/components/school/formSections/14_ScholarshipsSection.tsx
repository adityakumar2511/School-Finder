            ...
            >
              <CardContent className="p-6 space-y-4">
                ...
                <div className="space-y-1.5">
                  <Label className="font-heading text-label text-gray-800">Scholarship Name</Label>
                  <Input
                ...
                <div className="space-y-1.5">
                  <Label className="font-heading text-label text-gray-800">Eligibility Criteria</Label>
                  <Textarea
                ...
                <div className="space-y-1.5">
                  <Label className="font-heading text-label text-gray-800">Benefits</Label>
                  <Textarea
