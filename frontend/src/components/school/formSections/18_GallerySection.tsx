...
export default function GallerySection({
  ...
  return (
    <div className="space-y-6">
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <Label className="font-heading text-label text-gray-700">Caption</Label>
                        <Input
                      ...
                      <div className="space-y-1">
                        <Label className="font-heading text-label text-gray-700">Category</Label>
                        <select
      ...
      {/* ── Category filter chips (read display) ────────────── */}
      {fields.length > 0 && (
