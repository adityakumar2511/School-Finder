...
const FIELDS: { key: "academic" | "sports" | "awards" | "recognitions"; label: string; placeholder: string }[] = [
  {
    ...
    placeholder: "e.g. 100% board pass rate for 5 consecutive years, 3 students in IIT top 100…",
  },
  {
    key: "sports",
    label: "Sports Achievements",
    placeholder: "e.g. State-level cricket champions 2023, National athletics gold medal…",
  },
  {
    key: "awards",
    label: "Awards & Honours",
    placeholder: "e.g. Best School Award by CBSE 2022, ISO 9001 certified institution…",
  },
  {
    key: "recognitions",
    label: "Recognitions & Rankings",
    placeholder: "e.g. Ranked #1 in district by Education Times 2023…",
  },
];
